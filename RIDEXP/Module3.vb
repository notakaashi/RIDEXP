...
Public Module Module3
    ...
    Private Function GetRentalDataFromDatabase(rentalId As Integer) As Object
        Try
            ...
            Using conn As New MySqlConnection("server=localhost;userid=root;password=;database=ridexp")
                conn.Open()
                        ...
                        If reader.Read() Then
                            ...
                            Return New With {
                                ...
                                .LastName = If(IsDBNull(reader("last_name")), "N/A", reader("last_name").ToString()),
                                 .DateOfBirth = If(IsDBNull(reader("date_of_birth")), "N/A", reader("date_of_birth").ToString()),
                                ...
                                .LicenseNumber = If(IsDBNull(reader("license_number")), "N/A", reader("license_number").ToString()),
                                 .LicenseExpiry = If(IsDBNull(reader("license_expiry")), "N/A", reader("license_expiry").ToString()),
                                ...
                                .PickupDate = If(IsDBNull(reader("pickup_date")), "N/A", reader("pickup_date").ToString()),
                                .PickupTime = If(IsDBNull(reader("pickup_time")), "N/A", reader("pickup_time").ToString()),
                                .ReturnDate = If(IsDBNull(reader("return_date")), "N/A", reader("return_date").ToString()),
                                .ReturnTime = If(IsDBNull(reader("return_time")), "N/A", reader("return_time").ToString()),
